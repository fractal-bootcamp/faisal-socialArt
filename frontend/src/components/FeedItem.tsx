    ...
    return (
        <div className="feed-item">
            <Controllers
                ...
                style={style}
                onColorAChange={(color) => {/* Handle color A change */ }}
                onColorBChange={(color) => {/* Handle color B change */ }}
                onStripeCountChange={(count) => {/* Handle stripe count change */ }}
                onStyleChange={(newStyle) => {/* Handle style change */ }}
            />
